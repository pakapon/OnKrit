        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    <div class="mt-4">
                        <h4 class="mb-3">ออกจากระบบเรียบร้อยแล้ว!!</h4>
                                    ...
                                    <form method="post" action="login.php">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup mb-3 ">
                                                <input type="password" class="form-control pe-5 password-input" placeholder="Enter password" name="password-input" id="password-input">
