    ...
    <div id="layout-wrapper">
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <div class="text-center mt-sm-5 mb-4 text-white-50">
                        <div>
                            <a href="index.php?page=dashboard" class="d-block d-sm-none">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link <?php echo $active[1] == 1 ? 'active' : ''; ?>" href="index.php?page=dashboard">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown <?php echo $active[2] == 1 ? 'show' : ''; ?>" id="sidebarApps1">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="index.php?page=adduser" class="nav-link fs-15  <?php echo $subactive[21] == 1 ? 'active' : ''; ?>" data-key="t-api-key">เพิ่มลูกค้า</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="index.php?page=listuser" class="nav-link fs-15 <?php echo $subactive[22] == 1 ? 'active' : ''; ?>" data-key="t-api-key">รายการลูกค้า</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown <?php echo $active[3] == 1 ? 'show' : ''; ?>" id="sidebarApps2">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="#sidebarCrm" class="nav-link collapsed fs-15" data-bs-toggle="collapse" role="button" aria-expanded="<?php echo $active[31] == 1 ? 'true' : 'false'; ?>" aria-controls="sidebarCrm" data-key="t-level-2.2"> เพิ่มโครงการ
                                        </a>
                                        <div class="collapse menu-dropdown <?php echo $active[31] == 1 ? 'show' : ''; ?>" id="sidebarCrm">
                                            <ul class="nav nav-sm flex-column">
                                                <li class="nav-item">
                                                    <a href="index.php?page=addSolar" class="nav-link fs-14 <?php echo $subactive[31] == 1 ? 'active' : ''; ?>" data-key="t-level-3.1"> เพิ่มโครงการโซลาร์เซลล์
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="index.php?page=addEV" class="nav-link fs-14 <?php echo $subactive[32] == 1 ? 'active' : ''; ?>" data-key="t-level-3.2"> เพิ่มโครงการอีวีชาร์จเจอร์
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <li class="nav-item">
                                        <a href="index.php?page=listProject" class="nav-link fs-15 <?php echo $subactive[33] == 1 ? 'active' : ''; ?>" data-key="t-api-key">รายการโครงการ</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown <?php echo $active[4] == 1 ? 'show' : ''; ?>" id="sidebarApps4">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="index.php?page=addProduct" class="nav-link fs-15 <?php echo $subactive[41] == 1 ? 'active' : ''; ?>" data-key="t-api-key">เพิ่มสินค้า</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="index.php?page=viewProduct" class="nav-link fs-15 <?php echo $subactive[42] == 1 ? 'active' : ''; ?>" data-key="t-api-key">รายการสินค้า</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="index.php?page=addProductType" class="nav-link fs-15 <?php echo $subactive[43] == 1 ? 'active' : ''; ?>" data-key="t-api-key">จัดการหน่วยสินค้า</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link <?php echo $active[5] == 1 ? 'active' : ''; ?>" href="#sidebarApps6" data-bs-toggle="collapse" role="button" aria-expanded="<?php echo $active[5] == 1 ? 'true' : 'false'; ?>" aria-controls="sidebarApps">
                                <i data-feather="printer" class="icon-dual"></i> <span data-key="t-apps6">พิมพ์เอกสาร</span>
                            </a>
                            <div class="collapse menu-dropdown <?php echo $active[5] == 1 ? 'show' : ''; ?>" id="sidebarApps6">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="index.php?page=waranty" class="nav-link fs-15 <?php echo $subactive[51] == 1 ? 'active' : ''; ?>" data-key="t-api-key">พิมพ์ใบรับประกัน</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="index.php?page=report" class="nav-link fs-14 <?php echo $subactive[52] == 1 ? 'active' : ''; ?>" data-key="t-api-key">พิมพ์รายงานบริการ</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link <?php echo $active[6] == 1 ? 'active' : ''; ?>" href="index.php?page=dockStore">
        ...
        switch ($_GET["page"]) {
            ...
            case "addSolar":
                ...
                break;
            case "editSolar":
                include 'project/editSorlar.php';
                break;
            case "addEV":
                include 'project/addSolar.php';
                break;
            ...
            case "dockStore":
                ...
                break;
            case "waranty":
                include 'pdf/warantyDoc.php';
                break;
            case "report":
                include 'pdf/reportDoc.php';
                break;
            case "warantyprint":
                include 'pdf/warantyPDF.php';
                break;
